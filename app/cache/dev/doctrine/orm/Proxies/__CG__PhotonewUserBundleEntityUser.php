...
namespace Proxies\__CG__\Photonew\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Photonew\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Photonew\\UserBundle\\Entity\\User' . "\0" . 'ville', '' . "\0" . 'Photonew\\UserBundle\\Entity\\User' . "\0" . 'commandes', '' . "\0" . 'Photonew\\UserBundle\\Entity\\User' . "\0" . 'userNom', '' . "\0" . 'Photonew\\UserBundle\\Entity\\User' . "\0" . 'userPrenom', '' . "\0" . 'Photonew\\UserBundle\\Entity\\User' . "\0" . 'userTel', '' . "\0" . 'Photonew\\UserBundle\\Entity\\User' . "\0" . 'userDateInsc', '' . "\0" . 'Photonew\\UserBundle\\Entity\\User' . "\0" . 'userAdNum', '' . "\0" . 'Photonew\\UserBundle\\Entity\\User' . "\0" . 'userAdRue', '' . "\0" . 'Photonew\\UserBundle\\Entity\\User' . "\0" . 'userAdComp', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
     ...
     * {@inheritDoc}
     */
    public function addCommande(\Photonew\MainBundle\Entity\Commande $commande)
    {
     ...
     * {@inheritDoc}
     */
    public function removeCommande(\Photonew\MainBundle\Entity\Commande $commande)
    {
    ...
    public function getUserTel()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUserTel', array());

        return parent::getUserTel();
    }

    /**
     * {@inheritDoc}
     */
    public function getUserDateInsc()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUserDateInsc', array());

        return parent::getUserDateInsc();
    }

    /**
     * {@inheritDoc}
     */
    public function getUserAdNum()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUserAdNum', array());

        return parent::getUserAdNum();
    }

    /**
     * {@inheritDoc}
     */
    public function getUserAdRue()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUserAdRue', array());

        return parent::getUserAdRue();
    }

    /**
     * {@inheritDoc}
     */
    public function getUserAdComp()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUserAdComp', array());

        return parent::getUserAdComp();
    }
    ...
    public function setUserTel($userTel)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUserTel', array($userTel));

        return parent::setUserTel($userTel);
    }

    /**
     * {@inheritDoc}
     */
    public function setUserDateInsc(\DateTime $userDateInsc)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUserDateInsc', array($userDateInsc));

        return parent::setUserDateInsc($userDateInsc);
    }

    /**
     * {@inheritDoc}
     */
    public function setUserAdNum($userAdNum)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUserAdNum', array($userAdNum));

        return parent::setUserAdNum($userAdNum);
    }

    /**
     * {@inheritDoc}
     */
    public function setUserAdRue($userAdRue)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUserAdRue', array($userAdRue));

        return parent::setUserAdRue($userAdRue);
    }

    /**
     * {@inheritDoc}
     */
    public function setUserAdComp($userAdComp)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUserAdComp', array($userAdComp));

        return parent::setUserAdComp($userAdComp);
    }
