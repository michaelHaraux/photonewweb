...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'photonew.registration.form.type' => 'getPhotonew_Registration_Form_TypeService',
            'photonew_main.menu.breadcrumb' => 'getPhotonewMain_Menu_BreadcrumbService',
            'photonew_main.menu.primary' => 'getPhotonewMain_Menu_PrimaryService',
            'photonew_main.menu_builder' => 'getPhotonewMain_MenuBuilderService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'photonew', 'user' => 'root', 'password' => 'admin', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_5b1b25fdb959aa252b6905b2e02f5242');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_5b1b25fdb959aa252b6905b2e02f5242');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_5b1b25fdb959aa252b6905b2e02f5242');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Photonew\\MainBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Photonew\\UserBundle\\Entity')));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Photonew\\MainBundle\\Entity');
        $f->addDriver($e, 'Photonew\\UserBundle\\Entity');
        ...
        $g->setEntityNamespaces(array('PhotonewMainBundle' => 'Photonew\\MainBundle\\Entity', 'PhotonewUserBundle' => 'Photonew\\UserBundle\\Entity'));
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Photonew\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Photonew\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'projet_client_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Photonew\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Photonew\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Photonew\\UserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'photonew.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Photonew\UserBundle\Form\RegistrationFormType A Photonew\UserBundle\Form\RegistrationFormType instance.
     */
    protected function getPhotonew_Registration_Form_TypeService()
    {
        return $this->services['photonew.registration.form.type'] = new \Photonew\UserBundle\Form\RegistrationFormType('Photonew\\UserBundle\\Entity\\User');
    }

    /**
     * Gets the 'photonew_main.menu.breadcrumb' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * 
     * @throws InactiveScopeException when the 'photonew_main.menu.breadcrumb' service is requested while the 'request' scope is not active
     */
    protected function getPhotonewMain_Menu_BreadcrumbService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('photonew_main.menu.breadcrumb', 'request');
        }

        return $this->services['photonew_main.menu.breadcrumb'] = $this->scopedServices['request']['photonew_main.menu.breadcrumb'] = $this->get('photonew_main.menu_builder')->createBreadcrumbMenu($this->get('request'));
    }

    /**
     * Gets the 'photonew_main.menu.primary' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Knp\Menu\MenuItem A Knp\Menu\MenuItem instance.
     * 
     * @throws InactiveScopeException when the 'photonew_main.menu.primary' service is requested while the 'request' scope is not active
     */
    protected function getPhotonewMain_Menu_PrimaryService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('photonew_main.menu.primary', 'request');
        }

        return $this->services['photonew_main.menu.primary'] = $this->scopedServices['request']['photonew_main.menu.primary'] = $this->get('photonew_main.menu_builder')->createPrimaryMenu($this->get('request'));
    }

    /**
     * Gets the 'photonew_main.menu_builder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Photonew\MainBundle\Menu\MenuBuilder A Photonew\MainBundle\Menu\MenuBuilder instance.
     */
    protected function getPhotonewMain_MenuBuilderService()
    {
        return $this->services['photonew_main.menu_builder'] = new \Photonew\MainBundle\Menu\MenuBuilder($this->get('knp_menu.factory'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Photonew\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $n = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($k, array('login_path' => 'fos_user_security_login', 'always_use_default_target_path' => true, 'default_target_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('michaelharaux@gmail.com');
        $a->setPassword('mcd7ehlp2808');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Photonew\\UserBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Photonew\\MainBundle/Resources/views'), 'PhotonewMain');
        $instance->addPath(($this->targetDirs[3].'\\src\\Photonew\\UserBundle/Resources/views'), 'PhotonewUser');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PhotonewUserBundle' => 'Photonew\\UserBundle\\PhotonewUserBundle',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'michaelharaux@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'mcd7ehlp2808',
            ...
            'fos_user.model.user.class' => 'Photonew\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'projet_client_registration',
